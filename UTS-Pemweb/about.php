      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            <h3>Illustrator &amp; Graphic Designer</h3>
            <p class="fst-italic">
              Designing posters, flyers, instagram feeds, logos, and websites is always been my passion.
            </p>
            <div class="row">
              <div class="col-lg-12 ">
                    ...
                    $row = mysqli_fetch_assoc($execStrSQL)
                    ?>
                          <p class="bi bi-rounded-right"> <strong>Name      : </strong><?= $row["Name"]; ?></p>
                          <p class="bi bi-rounded-right"> <strong>Age       : </strong><?= $row["Age"]; ?></p>
                          <p class="bi bi-rounded-right"> <strong>Birthday  : </strong><?= $row["Birthday"]; ?></p>
                          <p class="bi bi-rounded-right"> <strong>City      : </strong><?= $row["City"]; ?></p>
                          <p class="bi bi-rounded-right"> <strong>Nationality : </strong><?= $row["Nationality"]; ?></p>
                          <br>
            ...
            <p>If you are interested in seeing what software i use to design please click the button down below, thank you!</p> 
            <div id="button" class="container d-flex flex-column align-items-center">
            <a href="skills.php" class="btn-skills">My Skills</a>
            </div>
